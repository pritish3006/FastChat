  ...
  if (messages.length === 0) {
    return <div className="flex flex-col h-full">
        <div className="flex-1 flex items-center justify-center">
          <motion.div className="max-w-lg text-center px-4" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          <AnimatePresence initial={false}>
            ...
            return <motion.div key={message.id} initial={{
              ...
              duration: 0.3
                  ...
                  {isUser ? <UserMessage message={message} /> : <BotMessage message={message} isLastMessage={index === messages.length - 1} />}
                </motion.div>;
          })}
          </AnimatePresence>
